...
import { Brain, Eye, DollarSign, Clock, ArrowRight, Calendar, Database, BarChart3, Zap, type LucideIcon } from 'lucide-react';
...
export default async function AITrackingPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const t = await getTranslations('services/ai-tracking');
