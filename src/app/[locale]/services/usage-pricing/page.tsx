...
import { Clock, DollarSign, ArrowRight, Calendar, Zap, Database, BarChart3, Settings, TrendingUp, type LucideIcon } from 'lucide-react';
...
export default async function UsagePricingPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  const t = await getTranslations('services/usage-pricing');
